+function($) {
    ...
    Timeline.DEFAULT_OPTIONS = {
        ...
        apiUrl : '//api.freifunk.net/ics-collector/CalendarAPI.php',
        source : 'all',
        ...
        function insertRow(data) {
            ...
            var eventHead = eventDiv.append('<div class="tl-event-head">').find('.tl-event-head');
						if ( self.options.source == 'all' && data.summary == null ) {
							...
							eventDiv.append('<div class="tl-event-body">' + (data.description ? escapeHtml(data.description) : 'Ohne Beschreibung.'));
						} else if ( self.options.source == 'all' ) {
							eventHead.append('<div class="tl-event-source">' + data.source);
							eventDiv.append('<div class="tl-event-body">' + (data.summary ? escapeHtml(data.summary) : (data.description ? escapeHtml(data.description)  : 'Ohne Beschreibung.')));
						} else {
							...
							eventDiv.append('<div class="tl-event-body">' + (data.description ? shortenString(escapeHtml(data.description), self.options.descLength, self.options.readMoreString) : 'Ohne Beschreibung.'));
						}
