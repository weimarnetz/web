  ...
  <div class="container">
    ...
    <!-- CONTENT -->
      ...
      <div id="content">
        ...
        Sprich mit deinem Freundeskreis, Geschäftspartner_innen und allen Menschen die dich umgeben und verbreite die Idee von Freifunk.
        ...
        <p>
          Komm zum <a href="../contact">Freifunk-Treffen</a> oder frag auf der <a href="../contact">Mailingliste</a>. Du kannst uns auch mit <a href="http://www.betterplace.org/de/projects/14418-berlin-freifunk-net">Spenden</a> unterstützen.
        </p>
        ...
        <div class="col-sm-3 col-lg-4">
          ...
          <div class="case" id="case-starter">
            <div class="case-head page-header">
              ...
              <img src="../img/participate/participate_small.png">
            </div>
            <div class="case-body">
              <dl>
                <dt>Du möchtest</dt>
        ...
        <div class="col-sm-3 col-lg-4">
          <div class="case" id="case-level2">
            <div class="case-head page-header">
              ...
              <img src="../img/participate/participate_medium.png">
            </div>
            <div class="case-body">
              <dl>
              <dt>Du möchtest</dt>
      ...
      <div class="col-sm-3 col-lg-4">
        <div class="case" id="case-backbone">
          <div class="case-head page-header">
            ...
            <img src="../img/participate/participate_big.png">
          </div>
          <div class="case-body">
            <dl>
              <dt>Du möchtest</dt>
...
Die Inhalte dieser Seite wurden von <a href="http://berlin.freifunk.net" target="_window">Freifunk Berlin</a> übernommen und angepasst.
