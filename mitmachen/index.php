...
<div class="row">
	...
	<div class="col-sm-4 col-lg-4">
		<div class="case" id="case-backbone">
			...
			<div class="case-body">
				<p>Erweitere das Netz durch hohe und exponierte Standorte. Unter oder auch auf dem Dach montiert, können die sich Router besser direkt miteinander verbinden. Das Netz wird so stabiler und ausfallsicherer.</p>
			</div>
		</div>
	</div>
...
<p>Programmierer und Entwickler können die <a href="https://github.com/weimarnetz/weimarnetz/blob/master/README.md">Firmware</a> und andere Weimarnetz-Software direkt auf <a href="https://github.com/weimarnetz/">Github</a> einsehen und bearbeiten. Dort und im Wiki beschrieben findest du alles um dir eine Entwicklungsumgebung aufzusetzen um dich an der Weiterentwicklung zu beteiligen.
</p>
...
<dd>Wenn ein Router direkt oder indirekt über andere das Internet erreichen kann, wird er automatisch Teil des <em>Virtual Privat Networks</em>. Jeder Router der sich mit anderen Routern über Funk verbinden kann, bildet zusammen mit diesen ein Maschennetz (engl. Mesh-Network). Das Mesh-Net beschreibt vielmehr die besondere Eigenschaft des Netzwerks &mdash; auch ohne Kabel &mdash; Teilnehmer unterschiedlicher Router miteinander zuverbinden.

Das Freifunk Wiki klärt VPN so:
