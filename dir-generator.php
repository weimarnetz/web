...
print	" <div class='container'>
	...
	<table summary='Directory Listing' class='table table-hover table-condensed'>";
...
foreach($folderlist as $folder) {
	...
	print "<td class='m'>" . date('Y-M-d H:m', $folder['modtime']) . "</td>";
...
foreach($filelist as $file) {
	...
	print "<td class='m'>" . date('Y-M-d H:m', $file['modtime'])   . "</td>";
